...
1. 为保障您的账号、网络、运营及系统安全，预防钓鱼网站欺诈及木马病毒，在您使用本产品的过程中，我们可能会收集您的设备信息，包括您使用轻松刷剧时的设备信息包括国际移动设备识别码（IMEI）、唯一设备标识符（MEID、MEID1）、设备序列号、androidID、国际移动用户设备码（IMSI）、网络设备硬件地址（设备 MAC 地址、IP 地址）、浏览信息、点击信息、传感器信息。请您理解，当您处于设备屏幕中的轻松刷剧 APP 切换至后台运行时，由于部分设备机型及系统原因，您此前使用轻松刷剧相关功能而产生的信息收集行为，可能无法立即停止，从而将导致短暂的后台信息收集行为即我们可能会在您的设备处于后台 / 静默状态时收集。

（三）向您提供其他相关产品功能和 / 或服务

为实现以下各项产品功能和 / 或服务，我们可能需要向您收集相对应的个人信息和 / 或权限，若您拒绝提供，则无法使用该等特定服务。

1. 客户服务：当您向轻松刷剧 APP 反馈、咨询遇到的问题时，您可以通过语音、文字、发送图片的方式向客服提起投诉、进行咨询或者申诉时，为了方便与您联系或者帮您解决问题，我们可能需要向您获取本政策条款（四）列表中的部分权限，同客服会根据您的实际问题在对话时向您要求提供姓名、手机号码、电子邮件及其他有效联系方式等个人信息。如您拒绝提供个人信息，我们可能无法向您及时反馈相关处理结果。  
2. 轻松刷剧记忆服务：当您登录并调用轻松刷剧的相关进度，查看相关记录，例如：产品进度、等级记录等相关内容，我们会记录您的再次使用记录，以便下次登录时直接给你适合的匹配信息，方便您使用。  
3. 技术优化服务：当您使用轻松刷剧的答题服务时，我们会使用相关技术计算您每个关卡的时长等相关信息，更准确快速的反馈产品难度报告，这是为了达成更好地服务效果，给您更好的体验。这类信息是为提供本服务必须收集的信息，收集后即作去标识化处理，不会用于识别任何特定的用户  
4. 内容、音乐播放展示服务：我们可能收集您的收集您使用轻松刷剧的设备信息、网络设备硬件地址（设备 MAC 地址、IP 地址）根据不同的设备型号以实现产品内容流畅播放、完整展示。  
5. 广告精准营销：为了便于您更好地收集管理您得偏好，获得更轻松的访问体验，我们可能需要您根据自身实际情况自主填写您的性别、生日、偏好、习惯、位置、操作习惯等；您的设备信息、应用列表信息和您的设备识别码会进行特征分析和用户人群画像。我们会努力保障您的体验，如果您不想接受我们给您发送的商业广告，您可以通过我们提供的方式进行退订或关闭。操作路径：设置—个性化推荐（选择开启或关闭）。在关闭后，您仍然会看到广告，您看到的广告数量不会变化，但广告的相关性会降低。此外，选择关闭 “个性化推荐” 后，不会停止您的信息收集，但是收集的信息不会用于算法相关服务。  
6. 广告播放服务：我们可能收集您的网络运营商及种类、网络类型、WIFI 名称，以实现在广告播放中帮助您节省流量的目的。例如：当我们监测到您处于 wifi 环境下，我们可能直接为您播放视频类广告内容；当我们检测到您处于无网络、或弱网络的环境下，我们仅为您播放您已经缓存的本地内容。  
7. 维护产品安全及时排除故障：为维护我们产品的正常运行，以及保障您的账号安全、排查产品故障，解决您遇到的产品问题、改进及优化我们的服务，我们会收集您的设备型号信息、IP 地址、操作日志信息。这类信息时为提供服务必须收集的信息，收集后即作去标识化处理，不会用于识别任何特定用户。  
8. 保障 “产品内钱包、账号” 安全：当您在使用修改密码、安全验证、申诉行为，且操作行为存在异常时，我们可能会要求您提供有效身份信息，以确保上述操作行为的安全性。  
9. 用于分享和邀请好友服务：如您将轻松刷剧中的内容分享至第三方平台时，我们会读取您的应用列表信息用以判断该第三方平台是否存在从而达成分享目的；如您使用 APP 内的相关功能时，我们也会读取您的应用列表信息用于判断该第三方应用是否存在以完成对应功能。  
10. 开展营销活动：轻松刷剧会根据运营情况适时推出各种营销活动，您选择参加时，根据活动情况您需提供 姓名、联系地址及联系方式、银行账号或第三方支付账号信息。 这些信息中可能包含个人敏感信息（包括银行账号或第三方支付账号），拒绝提供这些信息，我们将无法兑现您达成的活动结果，但不影响您正常使用 轻松刷剧的其他功能。  
*11、实名认证  
根据防沉迷相关法律法规的规定，满足相关主管部门的要求，确保为您提供流畅的产品或服务，保障产品的正常运行，我们会陆续在产品内接入了腾讯开放平台新版 YSDK。接入 YSDK 后，将由腾讯向您提供腾讯实名认证及防沉迷系统并收集相应信息。根据相关要求，腾讯有义务严格按照有关法律法规妥善保存、保护，不得用作其他用途。  
您在开始或继续使用本公司产品服务时需进行实名认证。腾讯会在获得您同意或您主动提供的情况下收集您的个人基本资料及个人身份信息，包括您的姓名、身份证号，个人身份信息属于敏感信息，如您拒绝提供个人身份信息可能会导致您无法使用我们的产品服务，或在使用服务过程中受到相应的限制。为实现实名认证的目的，您同意我们可以自行或委托第三方向有关机构提供、查询、核对您的前述身份信息。同时，我们会开展技术检测对产品接入的 We game SDK 进行安全监测，监测范围包含但不限于：个人敏感信息的传输和存储、信息安全管理能力，如超出约定行为，我们会切断接入。  
关于 We game SDK 的详细情况参见本政策 4.1 条。  
有关特定功能权限的提示：由于您移动设备的服务商或生产商不同，您终端弹窗特定功能权限显示也可能存在差别，如您需要关闭为使用上述特定功能而开启的功能权限时，大多数移动设备都会支持您的这项需求，具体方法请参考或联系您移动设备的服务商或生产商。您也可以与我们联系。请您注意，您开启任一权限即代表您授权我们可以收集和使用相关信息来为您提供对应服务，您一旦关闭任一权限即代表您取消了授权，我们将不再基于对应权限继续收集和使用相关信息，也无法为您提供该权限所对应的服务。但是，您关闭权限的决定不会影响此前基于您的授权所进行的信息收集及使用。  

（四）我们获取的权限 / 信息对应的业务功能（列表）

我们仅会出于本政策所述的以下目的，按照业务功能所必需的最低频率获取相应手机权限。以下权限的获取方式包括以弹框形式向您提示并由您予以授权。同一权限在不同终端设备上的获取方式可能有所不同，具体应以您使用的终端设备实际采用的方式为准。部分手机权限是由第三方 SDK 获取， 关于第三方 SDK 的详细情况参见本政策 4.1 条。

<table bordercolor="#373828"><tbody><tr><th>申请的权限 / 信息</th><th>收集信息</th><th>用途</th></tr><tr><td>VIBRATE</td><td>震动权限</td><td>提供产品中的震动场景，震动提示功能需要</td></tr><tr><td>READ_PHONE_STATE</td><td>读取设备信息</td><td>获取用户设备的 IMEI，通过 IMEI 对用户进行唯一标识，以便统计分析服务</td></tr><tr><td>REQUEST_INSTALL_PACKAGES</td><td>允许未知来源安装</td><td>广告 sdk 需要（安装用户下载的应用）</td></tr><tr><td>QUERY_ALL_PACKAGES</td><td>查询设备安装列表</td><td>保障联动其他软件时的顺畅为开发者提供反作弊功能，剔除作弊设备</td></tr><tr><td>SupplementaryDID.ACCESS</td><td>信通院获取 oaid</td><td>根据用户的 oaid 进行来源归因并标识，以便提供软件服务</td></tr><tr><td>KW_SDK_BROADCAST</td><td>快手 sdk 广播</td><td>广告 sdk 需要</td></tr><tr><td>WAKE_LOCK</td><td>避免熄屏</td><td>广告 sdk 需要</td></tr><tr><td>READ_SETTINGS</td><td>读取系统设置</td><td>根据设置提供正确的软件内容</td></tr><tr><td>REORDER_TASKS</td><td>排序运行应用列表</td><td>对应用排序进行优化</td></tr><tr><td>GET_TASKS</td><td>获取运行应用列表</td><td>优化用户软件体验，保证服务顺畅</td></tr><tr><td>ACCESS_WIFI_STATE</td><td>查询 WiFi 状态</td><td>保证网络服务顺畅，判断当前所处环境是否正常、安全，提醒用户开启网络，保证程序正确运行</td></tr><tr><td>READ_EXTERNAL_STORAGE</td><td>读文件权限</td><td>纯图分享时候图片不被压缩，监控程序运行情况，在崩溃时收集到足够的排障信息</td></tr><tr><td>ACCESS_NETWORK_STATE</td><td>查询网络状态</td><td>保证用户网络连接状态并在有变更时提供相应服务</td></tr><tr><td>INTERNET</td><td>网络权限</td><td>允许应用程序联网和发送统计数据的权限，以便提供统计分析服务</td></tr><tr><td>WRITE_EXTERNAL_STORAGE</td><td>监控程序运行情况</td><td>在崩溃时收集到足够的排障信息</td></tr><tr><td>CAMERA</td><td>相机权限</td><td>客服功能会用到，方便用户拍照反馈问题</td></tr><tr><td>RECORD_AUDIO</td><td>录音权限</td><td>客服功能会用到，方便用户拍照反馈问题</td></tr><tr><td>FOREGROUND_SERVICE</td><td>前台服务</td><td>适配 android p，为用户提供更好的体验</td></tr></tbody></table>

您可以在设备的设置中选择关闭部分或者全部权限，这可能导致对应的部分业务功能无法实现或者无法达到预期效果。
...
<table bordercolor="#373828"><tbody data-v-fb1c4c4c=""><tr data-v-fb1c4c4c=""><th data-v-fb1c4c4c="">场景描述</th><th data-v-fb1c4c4c="">个人信息字段、类型</th><th data-v-fb1c4c4c="">用途和目的</th><th data-v-fb1c4c4c="">调用频率</th><th data-v-fb1c4c4c="">第三方机构名称</th><th data-v-fb1c4c4c="">数据是否去标识化传输</th><th data-v-fb1c4c4c="">官网链接（SDK 收集使用规则见第三方《隐私政策》）</th></tr><tr data-v-fb1c4c4c=""><td data-v-fb1c4c4c="">快手 SDK 广告请求（用于广告投放）</td><td data-v-fb1c4c4c="">设备信息、设备型号、软件系统版本、存储信息、运营商信息、设备时区、设备语言、网络信息等基础信息、设备标识（IMEI、MEID、OAID、AndroidId、IMSI、ICCID）、位置信息（IP 地址、MAC 地址、GPS 位置信息、基站信息、wifi 信息）、应用安装列表、传感器信息、SIM 卡激活信息</td><td data-v-fb1c4c4c="">广告投放、广告归因、反作弊、安全</td><td data-v-fb1c4c4c="">1 次</td><td data-v-fb1c4c4c="">北京快手广告有限公司</td><td data-v-fb1c4c4c="">是</td><td data-v-fb1c4c4c="">https://u.kuaishou.com/home/detail/1220</td></tr><tr data-v-fb1c4c4c=""><td data-v-fb1c4c4c="">百度 sdk 广告请求</td><td data-v-fb1c4c4c="">设备信息：设备品牌、型号、软件系统版本、分辨率、网络信号强度、传感器信息，磁盘总空间、系统总内存空间、手机重启信息、手机系统更新时间等基础信息、OAID、AndroidID（仅 Andriod 端采集）设备信息：IMEI、IMSI、MEID（仅 Andriod 端采集）；IDFA（仅 iOS 端采集）位置信息 设备信息：屏幕宽高，屏幕像素密度，系统版本号，设备厂商，设备型号，手机运营商，手机网络状态，设备剩余存储空间，手机重启时间和更新时间</td><td data-v-fb1c4c4c="">1. 向最终用户提供或推荐相关程度更高（而非普遍推送）的搜索结果、信息流内容或者推广等信息，提升信息触达最终用户的效率以及准确率，同时避免虚假点击、违规推广、流量劫持等违法违规行为对最终用户体验及联盟市场合作秩序造成损害。 2. 评估信息触达最终用户的效率以及准确率，优化信息提供及推广的服务体验，以便提供更符合最终用户需求的信息内容，以减少无用信息及推广对最终用户的打扰</td><td data-v-fb1c4c4c="">对应场景使用时获取</td><td data-v-fb1c4c4c="">百度在线网络技术（北京）有限公司</td><td data-v-fb1c4c4c="">是</td><td data-v-fb1c4c4c="">https://union.baidu.com/bqt/#/legal/policies</td></tr><tr data-v-fb1c4c4c=""><td data-v-fb1c4c4c="">buglySDK</td><td data-v-fb1c4c4c="">手机设备信息、网络状态、手机品牌、Android 系统版本、Android 系统 api 等级、厂商系统版本、cpu 属性、磁盘空间占用大小、设备是否 root 等</td><td data-v-fb1c4c4c="">排查崩溃问题, 帮助 APP 提升稳定性</td><td data-v-fb1c4c4c="">对应场景使用时获取</td><td data-v-fb1c4c4c="">深圳市腾讯计算机系统有限公司</td><td data-v-fb1c4c4c="">是</td><td data-v-fb1c4c4c="">https://privacy.qq.com/document/preview/fc748b3d96224fdb825ea79e132c1a56</td></tr><tr data-v-fb1c4c4c=""><td data-v-fb1c4c4c="">移动安全联盟 SDK</td><td data-v-fb1c4c4c="">手机设备信息（设备制造商、设备型号、设备品牌）、网络信息、运行中的进程</td><td data-v-fb1c4c4c="">判断终端品牌，调用接口、判断是否为虚拟机环境</td><td data-v-fb1c4c4c="">对应场景使用时获取</td><td data-v-fb1c4c4c="">移动安全联盟</td><td data-v-fb1c4c4c="">是</td><td data-v-fb1c4c4c="">http://www.msa-alliance.cn/col.jsp?id=122</td></tr><tr data-v-fb1c4c4c=""><td data-v-fb1c4c4c="">火山 SDK</td><td data-v-fb1c4c4c="">运营商信息、MCC 移动国家码、MNC 移动网络码、网络访问模式（WIFI 状态）、安卓 ID、CPU 信息、硬件序列号、IMEI、MAC 地址、MSIN、IMSI 详见第三方网站</td><td data-v-fb1c4c4c="">设备风险识别</td><td data-v-fb1c4c4c="">对应场景使用时获取</td><td data-v-fb1c4c4c="">北京火山引擎科技有限公司</td><td data-v-fb1c4c4c="">是</td><td data-v-fb1c4c4c="">https://www.volcengine.com/docs/6600/82955</td></tr><tr data-v-fb1c4c4c=""><td data-v-fb1c4c4c="">广点通 SDK</td><td data-v-fb1c4c4c="">粗略位置信息、设备信息（如设备制造商、设备型号、操作系统版本等）、设备标识符（如 IMEI、AndroidID、OAID、IDFA 等）、运行中的进程（宿主应用的包名、版本号）、广告数据（如曝光、点击数据等）。</td><td data-v-fb1c4c4c="">广告投放、广告归因、广告监测、反作弊</td><td data-v-fb1c4c4c="">1 次</td><td data-v-fb1c4c4c="">深圳市腾讯计算机系统有限公司</td><td data-v-fb1c4c4c="">是</td><td data-v-fb1c4c4c="">https://e.qq.com/dev/help_detail.html?cid=2005&amp;pid=5983</td></tr><tr data-v-fb1c4c4c=""><td data-v-fb1c4c4c="">巨量引擎 SDK</td><td data-v-fb1c4c4c="">设备标识符（如 IMEI、OAID、IMSI、ICCID、GAID（仅 GMS 服务）、MEID、设备序列号 build_serial，具体字段因软硬件版本不同而存在差异）、系统版本、MAC 地址、经纬度、应用列表、网络类型、SIM 卡信息、设备品牌、型号、软件系统版本、分辨率、网络信号强度、IP 地址、设备语言、传感器信息等基础信息、AndroidID</td><td data-v-fb1c4c4c="">广告投放及广告监测归因、反作弊、广告统计分析</td><td data-v-fb1c4c4c="">对应场景获取</td><td data-v-fb1c4c4c="">北京字节跳动科技有限公司</td><td data-v-fb1c4c4c="">是</td><td data-v-fb1c4c4c="">https://www.csjplatform.com/privacy</td></tr><tr data-v-fb1c4c4c=""><td data-v-fb1c4c4c="">同盾 SDK</td><td data-v-fb1c4c4c="">手机设备信息、手机终端唯一 标志信息 (IMEI/IDFA)、Android ID、IMSI、MEID、MAC 地址、SIM 卡序列号、设备序列号、设备类型、设备型号、系统类型、地理位置、登录 IP 地址、应用程序列表、传感器(光传感器、 重力传感器、磁场传感器、加速度传感器、陀螺仪传感器) 相关设备信息、蓝牙 MAC 地址、GPS 定位坐标、网关地址、无线 MAC 地址、无线 IP 地址、无线网络名称、国家代码、移动运营商、SIM 卡运营商、MNC、MCC、同盾自有标识、手机制式、网络制式、Wifi 子网掩码</td><td data-v-fb1c4c4c="">保障业务安全和风控、用户作弊行为检测和用户欺诈风险识别</td><td data-v-fb1c4c4c="">对应场景使用时获取</td><td data-v-fb1c4c4c="">浙江同盾科技有限公司</td><td data-v-fb1c4c4c="">是</td><td data-v-fb1c4c4c="">https://www.tongdun.cn/?R=bdjj&amp;renqun_youhua=236369</td></tr><tr data-v-fb1c4c4c=""><td data-v-fb1c4c4c="">TalkingData 应用统计分析 SDK</td><td data-v-fb1c4c4c="">IMSI、设备唯一标识码（IMEI/MEID/AndROIDID/IDFA/OPENUDID/GUID、sim 卡 ISIM 或 ICCID 信息）、系统版本、MAC 地址、IP 地址、ADID、安卓匿名设备标识符（OAID/VAID/AAID 等）、安卓广告主标识符、设备序列号、经纬度、应用列表、网络类型</td><td data-v-fb1c4c4c="">提供统计分析服务，通过应用列表校准数据准确性，提供基础反作弊能力</td><td data-v-fb1c4c4c="">对应场景使用时获取</td><td data-v-fb1c4c4c="">北京腾云天下科技有限公司</td><td data-v-fb1c4c4c="">是</td><td data-v-fb1c4c4c="">https://www.talkingdata.com/privacy.jsp?languagetype=zh_cn</td></tr><tr data-v-fb1c4c4c=""><td data-v-fb1c4c4c="">数盟 SDK</td><td data-v-fb1c4c4c="">设备基本情况信息、设备制造商、设备型号、设备系统版本、应用版本、传感器、陀螺仪、软件列表、设备网络状况信息及其他设备物理环境信息。不采集 2022 年 4 月 24 日发布的《信息安全技术移动互联网应用程序（App）收集个人信息基本要求（GB/T 41391-2022）》附录 F 的所有唯一识别码</td><td data-v-fb1c4c4c="">安全风控、检测设备欺诈与作弊行为，识别反馈设备真实性</td><td data-v-fb1c4c4c="">对应场景时获取</td><td data-v-fb1c4c4c="">北京数字联盟网络科技有限公司</td><td data-v-fb1c4c4c="">是</td><td data-v-fb1c4c4c="">https://www.shuzilm.cn/privacy.html</td></tr><tr data-v-fb1c4c4c=""><td data-v-fb1c4c4c="">腾讯浏览器 SDK</td><td data-v-fb1c4c4c="">设备标识信息（IMEI / 软件列表 / 硬件信息）、IMEI、IMSI、设备唯一标志码、系统版本、Mac 地址、经纬度、应用列表、网络类型、粗略位置信息、设备信息（磁场传感器）、标识符（IMEI/MEID（Device ID）、Android_ID）</td><td data-v-fb1c4c4c="">网页加载提供浏览器服务</td><td data-v-fb1c4c4c="">对应场景时获取</td><td data-v-fb1c4c4c="">深圳市腾讯计算机系统有限公司</td><td data-v-fb1c4c4c="">是</td><td data-v-fb1c4c4c="">https://x5.tencent.com/tbs/guide/develop.html</td></tr><tr data-v-fb1c4c4c=""><td data-v-fb1c4c4c="">美洽 SDK</td><td data-v-fb1c4c4c="">设备名称、操作系统、浏览器及版本、设备类型、唯一设备标识符 android ID/IDFA/OPENUDID/GUID、SIM 卡 本机号码 IMSI 信息等软硬件特征信息）、设备所在位置相关信息（例如 IP 地址、GPS 位置等传感器信息）、不同终端下获取的信息（例如 Openid、用户昵称、用户头像等信息）、移动设备、浏览器或其他程序所提供的配置信息、设备版本号、设备识别码等。为了向用户提供更好的服务与改善用户的服务体验，美洽科技可能会记录硬件型号、操作系统版本号、国际移动设备识别码（IMEI）、网络设备硬件地址（MAC）等软硬件数据。录音权限、存储权限、相机权限</td><td data-v-fb1c4c4c="">向用户提供更好的客服服务改善体验，数据分析、反作弊等</td><td data-v-fb1c4c4c="">对应场景使用时获取</td><td data-v-fb1c4c4c="">成都美洽网络科技有限公司</td><td data-v-fb1c4c4c="">是</td><td data-v-fb1c4c4c="">https://meiqia.com/privacy-clause</td></tr><tr data-v-fb1c4c4c=""><td data-v-fb1c4c4c="">We gameSDK*</td><td data-v-fb1c4c4c="">系统属性、设备型号、微信和 QQ 的账号基本信息 (包括账号、昵称及头像)、应用列表、网络权限（包括 MAC 地址、BSSID）</td><td data-v-fb1c4c4c="">便于快速定位解决系统兼容性问题<br>保证终端用户使用功能时所需的系统组件正常生效<br>快速定位解决机型兼容性问题<br>用于微信和 QQ 授权登录<br>检测是否安装了微信或者 QQ<br>允许程序访问网络连接</td><td data-v-fb1c4c4c="">实现弹窗展示，调用系统浏览器等与系统版本强相关的系统组件能力<br>后台上报与问题监控<br>提供微信和 QQ 授权登录<br>对应场景获取</td><td data-v-fb1c4c4c="">深圳市腾讯计算机系统有限公司</td><td data-v-fb1c4c4c="">去标识化、加密传输的安全处理方式</td><td data-v-fb1c4c4c="">https://developer.wegame.com/agreements/wegame_we_sdk_personal_information.html</td></tr><tr data-v-fb1c4c4c=""><td data-v-fb1c4c4c="">vivo 流量联盟 SDK（如有）</td><td data-v-fb1c4c4c="">设备信息：手机 imei（Android10 以下），手机 emmcid、usfid、版本号、版本名称 Android10 唯一标识符 (oaid、vaid、aaid)，其中，Android 10 唯一标识符，开发者标识仅适用于安卓 10 以后版本。网络信息（联网方式）手机制造商信息</td><td data-v-fb1c4c4c="">提供广告展示功能，实名认证统一登录</td><td data-v-fb1c4c4c="">对应场景使用时获取</td><td data-v-fb1c4c4c="">广东天宸网络科技有限公司</td><td data-v-fb1c4c4c="">是</td><td data-v-fb1c4c4c="">https://dev.vivo.com.cn/documentCenter/doc/548</td></tr><tr data-v-fb1c4c4c=""><td data-v-fb1c4c4c="">OPPO 广告联盟</td><td data-v-fb1c4c4c="">网路身份识别信息（IP 地址）、已安装应用列表、软件版本号、软件签名、软件包名、设备连接信息（电信运营商、网络环境）、设备属性信息（设备型号、操作系统版本、设备地理位置、IMEI、MAC 地址、OpenID、设备 SN 码）MAC 地址、Wi-Fi 信息（SSID\BSSID \ 信号强度 \ 连接情况）、电池电量、充电状态、充电方式、内存情况（总内存、可用内存）、存储情况（总存储、可用存储）、CPU 信息、Cookie（Android_ID、Cookie 时间戳、IP 地址）、IMSI、ICCID、Rom 构建时间、响铃模式、屏幕亮度、SIM 卡槽数、激活状态 SIM 卡数量、传感器信息（陀螺仪、加速度传感器、重力传感器）</td><td data-v-fb1c4c4c="">提供个性化广告服务，进行与营销推广内容有关的推送，例如提供并更新市场营销或推广内容。跟踪、处理、维护、改善我们提供给您的信息推广服务，包括按照您的网路身份识别信息、软件信息、设备属性信息等展示适合您的营销内容。统计和分析用于优化组件性能的相关数据信息，以更好的改进我们的服务。出于广告反作弊的目的</td><td data-v-fb1c4c4c="">对应场景获取</td><td data-v-fb1c4c4c="">广东欢太科技有限公司</td><td data-v-fb1c4c4c="">是</td><td data-v-fb1c4c4c="">https://u.oppomobile.com/main/privacy.html</td></tr><tr data-v-fb1c4c4c=""><td data-v-fb1c4c4c="">拼多多广告联盟</td><td data-v-fb1c4c4c="">设备型号、设备类型、设备配置、操作系统及版本、唯一设备标识符、国际移动设备身份码 IMEI、SIM 卡信息 IMSI、IOS 系统广告标识符（IDFA）、安卓系统广告标识符（OAID）、Android id、设备应用安装类别信息、日志信息、位置信息</td><td data-v-fb1c4c4c="">优化 / 推广信息服务体验，提升信息触达的准确率及效率；保障软件运行服务正常；提高服务安全性；减少无用信息打扰</td><td data-v-fb1c4c4c="">对应场景使用时获取</td><td data-v-fb1c4c4c="">上海寻梦信息技术有限公司</td><td data-v-fb1c4c4c="">是</td><td data-v-fb1c4c4c="">https://ssp.pinduoduo.com/web/user-agreement</td></tr><tr data-v-fb1c4c4c=""><td data-v-fb1c4c4c="">阿里云日志服务（SLS）SDK</td><td data-v-fb1c4c4c="">设备基础信息：设备制造商、设备品牌、设备型号、设备名称、设备操作系统信息、设备配置信息、设备环境信息；设备网络信息：网络运营商信息、网络类型、网络状态；设备应用信息：SDK 宿主 APP 信息（包括：应用名称、应用版本）。</td><td data-v-fb1c4c4c="">为了更好、更优、更准确的完成您所选择的服务</td><td data-v-fb1c4c4c="">对应场景获取</td><td data-v-fb1c4c4c="">阿里云计算有限公司</td><td data-v-fb1c4c4c="">是</td><td data-v-fb1c4c4c="">https://terms.aliyun.com/legal-agreement/terms/suit_bu1_ali_cloud/suit_bu1_ali_cloud202112131013_69952.html?spm=a2c4g.11186623.0.0.307e30e5lkzUo9</td></tr><tr data-v-fb1c4c4c=""><td data-v-fb1c4c4c="">Mintegral 广告 SDK</td><td data-v-fb1c4c4c="">位置信息：IP 地址，国家，时区和区域设置（国家和首选语言）；设备 / 广告 ID：国际移动设备识别码（IMEI）、安卓 ID、OAID、IDFV，移动广告标识符（如苹果 IDFA 或谷歌广告 ID）。注：如您依据本政策第 7 条限制了您的设备或应用软件获取您的设备 / 广告 ID，则我们将不会收集相应的信息；设备信息：设备生产商，设备型号，设备的操作系统信息，设备类型，设备屏幕信息，设备电池信息，设备音量及字体大小，是否为模拟器，设备网络信息，设备硬件信息，设备传感器信息，限制广告追踪（LAT）状态，手机开机时间，手机用户名摘要，设备存储容量信息；应用信息：Mintegral 合作方的应用包名，应用版本和特性，是否为 App Store 下载，SDK 版本，已安装应用列表 *；使用数据：当您与我们推广的广告发生互动，我们会收集到您与该广告互动的行为，如浏览、点击了该广告的相关信息。其他信息：设备事件信息（如系统崩溃，系统活动），时间戳，您提出请求的日期和时间以及来源网址，用户代理。</td><td data-v-fb1c4c4c="">广告投放及广告监测归因、反作弊、广告统计分析</td><td data-v-fb1c4c4c="">对应场景获取</td><td data-v-fb1c4c4c="">广州汇世信息科技有限公司</td><td data-v-fb1c4c4c="">是</td><td data-v-fb1c4c4c="">https://www.mintegral.com/cn/privacy</td></tr><tr data-v-fb1c4c4c=""><td data-v-fb1c4c4c="">腾讯 X5 浏览器</td><td data-v-fb1c4c4c="">手机型号、剪切板</td><td data-v-fb1c4c4c="">优化移动端 webview 体验，解决移动端 webview 使用过程中出现的一切问题；优化用户的浏览体验，准确控制内核版本下发和开关下发，以及基于 webview 标准协议；便于用户搜索、分享已复制的内容</td><td data-v-fb1c4c4c="">对应场景获取</td><td data-v-fb1c4c4c="">腾讯公司</td><td data-v-fb1c4c4c="">是</td><td data-v-fb1c4c4c="">https://x5.tencent.com/docs/questions.html</td></tr></tbody></table>
